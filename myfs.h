...
private:
	/*
	This function finds how much bytes of the 256 are in use
	In: position of the file
	Out: how much bytes of the 256 aren't 0
	*/
	int getFileSize(int pos);
	...
	/*
	Contains the information about a file/folder
	*/
	struct folder_node
	{
		char filename[11];
	...
	struct folder
	{
		struct folder_node arrOfFiles[4096];
